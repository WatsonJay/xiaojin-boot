package org.xiaojin.common.modules.redis.writer;
 ...
 * @Description TODO
 * @createTime 2024年05月14日 11:10:00
 */
public class XiaojinRedisCacheWriter implements RedisCacheWriter {

    private static final Logger log = LoggerFactory.getLogger(XiaojinRedisCacheWriter.class);
    private final RedisConnectionFactory connectionFactory;
    private final Duration sleepTime;
    private final CacheStatisticsCollector statistics;

    public XiaojinRedisCacheWriter(RedisConnectionFactory connectionFactory) {
        this(connectionFactory, Duration.ZERO);
    }

    public XiaojinRedisCacheWriter(RedisConnectionFactory connectionFactory, Duration sleepTime) {
